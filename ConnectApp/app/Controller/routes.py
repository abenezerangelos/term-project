...
def apply(position_id):
    ...
    application = Application(statement = aform.statement.data, faculty_name = aform.faculty_name.data, faculty_email = aform.faculty_email.data,
                              status = 'Pending')
    if position is None:
...
def edit_profile():
    ...
    if eform.validate_on_submit():
        print("eform.password.data", f"1{eform.password.data}1" )
        ...
        print("eform.password.data", f"3{eform.password.data}3")
